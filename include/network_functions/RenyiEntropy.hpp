...
class RenyiCorrelation : public kernel::RenyiCorrelation {
private:
...
public:
    RenyiCorrelation(const unsigned int N, const unsigned int num_params, const bool gpu);
