from ._pyRBMonGPU import PsiPair
...
setattr(PsiPair, "to_json", to_json)
setattr(PsiPair, "from_json", from_json)
setattr(PsiPair, "transform", transform)
setattr(PsiPair, "normalize", normalize)
setattr(PsiPair, "__pos__", __pos__)
setattr(PsiPair, "vector", vector)
